...
import { RxjsExample17DataService } from "./rxjs-example17-data.service";
...
function nonFlickerLoader<T>(data$: Observable<T>, delay: number = 1000, duration: number = 1000): Observable<T | null> {
