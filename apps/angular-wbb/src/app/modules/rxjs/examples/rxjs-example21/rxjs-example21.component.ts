...
import { createDefaultObserver, customMap, customOf, customTap } from "./rxjs-example21.custom-operators-rx";
import { CustomBehaviorSubject, CustomReplaySubject, CustomSubject, http } from "./rxjs-example21.custom-rx";
...
export class RxjsExample21Component implements OnInit {
    ...
    ngOnInit(): void {
        ...
        http('https://jsonplaceholder.typicode.com/users').subscribe(createDefaultObserver('subscriber-2'));
