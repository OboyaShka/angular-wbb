...
import { RxjsExample12ModalService } from "../rxjs-example12-modal.service";
...
export class RxjsExample12PortalComponent {
    ...
    constructor(@Inject(RxjsExample12ModalService) readonly modal$$: RxjsExample12ModalService) // @Inject(DOCUMENT) private documentRef: Document
    {}
}
